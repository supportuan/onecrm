...
export const findStudentForAuth = async (email: string) =>
  students.find((student) => student.email.toLowerCase() === email.toLowerCase()) || null;
...
export const getStudentDashboard = async (email: string) => {
