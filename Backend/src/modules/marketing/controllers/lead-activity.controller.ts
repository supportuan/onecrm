...
// import * as leadActivityService from '../services/lead-activity.service';

// import { createLeadActivitySchema } from '../validations/lead-activity.validation';
...
//         const validatedData =
//             createLeadActivitySchema.parse(req.body);

//         const activity =
//             await leadActivityService.createLeadActivity(
//                 leadId,
//                 validatedData
//             );
