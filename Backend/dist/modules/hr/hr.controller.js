...
import { createDeviceSchema, createNetworkSchema, updateSettingsSchema, requestRegularizationSchema, processRegularizationSchema, createLeavePlanSchema, createLeaveDefinitionSchema, assignLeaveEmployeesSchema, createHolidaySchema, executePayrollSchema, createSalaryStructureSchema, createEmployeeSchema, updateEmployeeSchema, uploadDocumentSchema, remoteClockInSchema, applyLeaveRequestSchema, processLeaveApprovalSchema, createGroupSchema, createBusinessGoalSchema, linkBusinessGoalSchema, createKpiSchema, createPerformanceReviewSchema, updatePerformanceReviewSchema, } from './hr.validation.js';
// ==========================================
...
export const assignAccessRole = async (req, res, next) => {
    try {
...
export const deleteDevice = async (req, res, next) => {
    try {
        ...
        if (!id)
            return sendError(res, 'Device ID is required', null, 400);
...
// ==========================================
export const getBiometricUsers = async (req, res, next) => {
    try {
...
export const getAttendanceEvents = async (req, res, next) => {
    try {
...
export const processBiometricLogs = async (req, res, next) => {
    try {
...
export const submitRemoteClockIn = async (req, res, next) => {
    try {
...
export const getRegularizations = async (req, res, next) => {
    try {
...
export const processRegularization = async (req, res, next) => {
    try {
        const id = req.params.id;
...
// ==========================================
export const getLeavePlans = async (req, res, next) => {
    try {
...
export const createLeavePlan = async (req, res, next) => {
    try {
...
export const getLeaveDefinitions = async (req, res, next) => {
    try {
...
export const addLeaveDefinition = async (req, res, next) => {
    try {
        const planId = req.params.planId;
...
export const deleteLeaveDefinition = async (req, res, next) => {
    try {
        const planId = req.params.planId;
...
export const getLeavePlanEmployees = async (req, res, next) => {
    try {
        const planId = req.params.planId;
...
export const assignLeavePlanEmployees = async (req, res, next) => {
    try {
        const planId = req.params.planId;
...
export const deleteHoliday = async (req, res, next) => {
    try {
        ...
        if (!id)
            return sendError(res, 'Holiday ID is required', null, 400);
...
export const updateEmployee = async (req, res, next) => {
    try {
        const id = req.params.id;
        if (!id?.trim())
            return sendError(res, 'Employee ID is required', null, 400);
...
export const applyLeaveRequest = async (req, res, next) => {
    try {
...
export const processLeaveApproval = async (req, res, next) => {
    try {
        const id = req.params.id;
...
export const getLeaveBalancesReport = async (req, res, next) => {
    try {
...
export const generateOfferLetterPdf = async (req, res, next) => {
    try {
...
// 14. Business Goals
// ==========================================
export const getBusinessGoals = async (req, res, next) => {
    try {
...
export const createBusinessGoal = async (req, res, next) => {
    try {
...
export const linkBusinessGoalToHr = async (req, res, next) => {
    try {
...
// ==========================================
export const getAttendanceTemplates = async (req, res, next) => {
    try {
...
export const getAttendanceTemplate = async (req, res, next) => {
    try {
        const data = await hrService.getAttendanceTemplate(req.params.id);
...
export const getAttendanceSummaryReport = async (req, res, next) => {
    try {
...
// ==========================================
export const getCounselorMetrics = async (req, res, next) => {
    try {
        const id = req.params.id;
...
export const getMarketingTeamKpis = async (req, res, next) => {
    try {
...
// ==========================================
export const getKpiDefinitions = async (req, res, next) => {
    try {
...
export const createKpiDefinition = async (req, res, next) => {
    try {
