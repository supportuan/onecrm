      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <FileText className="w-7 h-7 text-neutral-700" />
            Offer Letters
          </h1>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-neutral-900 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-neutral-800"
        >
        ...
        {Object.entries(STATUS_META).map(([status, meta]) => {
          ...
          return (
            <button
              ...
              className={`rounded-xl p-3 text-left border transition-all ${filterStatus === status ? 'ring-2 ring-offset-1 ring-neutral-500 border-neutral-200' : 'border-gray-100 hover:border-gray-200'} bg-white shadow-sm`}
            >
          ...
          <div className="bg-white rounded-xl shadow-xl w-auto p-6 max-h-[90vh] overflow-y-auto">
              ...
              {[
                ...
                <div key={f.key} className={f.key === 'candidateName' || f.key === 'candidateEmail' ? 'col-span-1' : ''}>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-neutral-700"
                  />
                </div>
              ))}
              <div>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                disabled={submitting}
                className="flex-1 bg-neutral-900 text-white rounded-lg py-2 text-sm font-medium hover:bg-neutral-800 disabled:opacity-50 flex items-center justify-center gap-2"
              >
